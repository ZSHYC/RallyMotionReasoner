...
from rallymotionreasoner.features.ball_trajectory import trajectory_rows
...
def shot_feature_payload(
    ...
    """Select hit-node features for both exported datasets and live RGR input."""
...
class RegionFeatureExtractor:
    """Reuse RallyMotionReasoner's DINO provenance while adding four raw-image regions."""
